...
<div region="north" border="false" style="overflow: hidden; width: 100%; height:40px; background:#D9E5FD;">
    <div style="overflow: hidden; padding:2px 0 0 5px;">
        <p>系统后台<span>登陆时间:{{dateformat .userinfo.Lastlogintime "2006-01-02 15:04:05"}}</span> 现在时间：<span id='nowDateTimeSpan'></span></p>
    </div>
<!--     <ul class="ht_nav">
        {{range .groups}}
    ...
    <div id="header-inner" style="float:right; overflow:hidden; height:40px; width:300px; line-height:25px; text-align:right; padding:20px;margin-top:-50px; ">
